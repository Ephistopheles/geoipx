...
class DBIPConfig:
    ...
    def sql_count_city_v4(self) -> str:
        return f"SELECT COUNT(*) FROM {self._table_city_v4()};"

    def sql_count_city_v6(self) -> str:
        return f"SELECT COUNT(*) FROM {self._table_city_v6()};"
